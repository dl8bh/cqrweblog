...
?> 
  ...
  <div class="form-group col-md-1 col-sm-1 col-xs-4 <?php if (!isset($freq)) { echo "has-error has-feedback" ; }  ?>">	
  ...
  <div class="form-group col-md-2 col-sm-2 <?php if (empty($call)) { echo "has-error has-feedback" ; }  ?>">
  ...
  <div class="form-group col-md-1 col-sm-1 col-xs-4 ">
	...
	<div class="row">
			...
			<input class="btn btn-primary col-md-1 col-sm-1 col-xs-12 " type="submit" value="Log">
	</div>
	</form>
...
<?php
	...
	<input type="hidden" name="inlog" value="1"> 
		...
		<div class="col-md-1 col-sm-1 " ></div>
				...
				<div class="col-md-1 col-sm-1 "></div>
				<input class="btn btn-info col-md-1 col-sm-1 col-xs-4" data-toggle="tooltip" type="submit" value="QRZ?" onclick="qrz_call()" title="shortcut: Alt+q">
				<div class="col-md-2 col-sm-2"></div>
				<input class="btn btn-warning col-md-1 col-sm-1 col-xs-12" data-toggle="tooltip" type="submit" value="Cancel" onclick="wipe_data()" title="shortcut: Alt+w/F11">
</div>
