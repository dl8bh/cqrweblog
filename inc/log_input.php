...
?> 
	<div class="row ">
	<div class="form-group col-md-1 col-sm-2 col-xs-4 " >
  ...
  <div class="form-group col-md-2 col-sm-3 col-xs-12 <?php if (empty($call)) { echo "has-error has-feedback" ; }  ?>">
...
<?php
	...
	<input type="hidden" name="inlog" value="1"> 
		...
		<!--<div class="col-md-1 " ></div>-->
				...
				<div class="col-md-2 col-sm-3 col-xs-4">
				<input class="btn btn-info col-md-12 col-sm-12 col-xs-12" data-toggle="tooltip" type="submit" value="QRZ?" onclick="qrz_call()" title="shortcut: Alt+q"></div>
