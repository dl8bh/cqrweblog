<?php echo '<form class="form-inline" role="form" name="input" action="log2.php' . $urlparameter . '" method="post">'; ?>
  ...
  <button type="submit" class="btn btn-default">Submit</button>
	...
	<table align="center" class=" border="0">
	<td width="40">Band</td>
	<td width="10"></td>
	<td width="40">Time</td>
	<td width="10"></td>
...
//echo '<form name="input" action="log2.php' . $urlparameter . '" method="post">';
...
?>
	...
	<td></td>
  <div class="form-group form-horzizontal">
	...
	echo '<td><input class="btn btn-primary" type="submit" value="Log"></td>';
	echo '</form>' . "\n";
	echo '<td></td>';
?>
...
<?php
	...
	echo '<td><input class="btn btn-info" type="submit" value="Check DXCC" accesskey="C" title="shortcut browser accesskey + C"></td>';
...
echo '<form name="search" action="logsearch2.php' . $urlparameter . '" target="_blank"  method="post">';
echo '<td><input class="btn btn-info" type="submit" value="In log?" accesskey="S" title="shortcut browser accesskey + S" >' . "\n";
echo '<input type="hidden" name="call" value="">' . "\n";
echo '<input type="hidden" name="inlog" value="1">' . "\n";
echo '</form>';
?>
<input class="btn btn-info" type="submit" value="QRZ?" onclick="qrz_call()" title="shortcut: Alt+q"></td>
<td></td>
<td><input class="btn btn-warning" type="submit" value="Cancel" onclick="wipe_data()" title="shortcut: Alt+w/F11"></td>
<tr>
</tr>
</table>
<?php
